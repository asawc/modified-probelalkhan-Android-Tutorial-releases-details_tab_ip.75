...
public class SharedPrefManager {
    ...
    private static final String KEY_PRODUCT_ID = "keyproductid";
   ...
   /* //this method will give the registered employees
    ...
    public void removeProduct() {
        ...
        editor.remove(KEY_PRODUCT_QUANTITY);
        editor.remove(KEY_PRODUCTNAME);
        editor.remove(KEY_PRODUCTSYMBOL);
        //editor.putString(KEY_GENDER, user.getGender());
        editor.apply();
    }
    ...
    public Product getProduct() {
        ...
        return (product.getSymbol() != null ? product : null );
    }
